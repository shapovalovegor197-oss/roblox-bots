...
class Hand:
    ...
    # Замер 31.08 при чувствительности 1.0 и зафиксированной камере: 50 единиц
    # дают 0.66 град/ед, 100 — 0.55, 200 — уже 0.53. Потери начинаются раньше,
    # чем казалось, поэтому порция мелкая: 100 единиц.
    LOOK_CHUNK = 100
