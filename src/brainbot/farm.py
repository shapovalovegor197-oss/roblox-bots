...
class Farmer:
    ...
    def read_lock_flash(self) -> int | None:
        ...
        #
        # Длительность отсюда неизвестна, поэтому берём осторожные 45 с —
        # половину лока. Ошибка в меньшую сторону безопасна: бот вернётся к
        # плите раньше и снова прочитает либо счётчик, либо эту же надпись.
